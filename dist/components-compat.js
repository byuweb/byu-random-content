...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  "use strict";
  /* harmony import */
  var __WEBPACK_IMPORTED_MODULE_0__byu_random_content_html__ = __webpack_require__(10);
  ...
  var ByuRandomContent = function (_HTMLElement) {
    _inherits(ByuRandomContent, _HTMLElement);

    function ByuRandomContent() {
      _classCallCheck(this, ByuRandomContent);

      var _this = _possibleConstructorReturn(this, (ByuRandomContent.__proto__ || Object.getPrototypeOf(ByuRandomContent)).call(this));

      _this.attachShadow({ mode: 'open' });
      return _this;
    }

    _createClass(ByuRandomContent, [{
      key: 'connectedCallback',
      value: function connectedCallback() {
        var _this2 = this;

        //This will stamp our template for us, then let us perform actions on the stamped DOM.
        __WEBPACK_IMPORTED_MODULE_1_byu_web_component_utils__["a" /* applyTemplate */](this, 'byu-random-content', __WEBPACK_IMPORTED_MODULE_0__byu_random_content_html___default.a, function () {
